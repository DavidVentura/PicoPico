...
Spritesheet hud_sprites;
Spritesheet label;

// is 128*16*2 = 4KB
// Could be 64*8*2 = 1KB
uint8_t hud_buffer[SCREEN_WIDTH*HUD_HEIGHT*2];


// position is an index, from the right
void _draw_hud_sprite(Spritesheet* s, uint16_t sx, uint16_t sy, uint16_t xOffset, uint16_t yOffset) {
